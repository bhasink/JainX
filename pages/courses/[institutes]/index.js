    ...
    <div className="container">
      <nav aria-label="breadcrumb">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item active" aria-current="page">Individual Course Page</li>
        </ol>
      </nav>
    </div>
  </section>
      ...
      <div className="coursetextmoreinf">
        ...
        <div className="tab-content" id="myTabContent">
          ...
          <div className="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            <p>Instead of writing a static business plan, the learner will learn to design rapid prototypes to test and iterate business concepts. Whether for 
              new initiatives and ventures inside an existing business or organization, or for an entrepreneur ready to bring a startup to life, this course will help them 
              de-risk your business ideas and craft a sustainable business model that is rooted in the people they wish to serve.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section className="testimoniapn pb-0">
    <div className="container">
      ...
      <div className="dtabasedcateg mt-lg-5 mt-5">
        ...
        {institute &&  institute.courses && institute.courses.map((course, key) => (
            ...
            <div className="coursepanel">
              ...
              <div className="dtlsctaviews">
                ...
                <Link href={`${course.institute.slug}/${course.slug}`}>
                  <a href="#" className="grylghtcta">View Details</a>
                </Link>
      ...
      <div id="accordion8">
          ...
          <div className="card-header" id="headingOne">
            <h5 className="mb-0">
              <button className="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                Is the online degree program offered by JAIN (Deemed-
                to-be University) UGC entitled?
              </button>
            </h5>
          </div>
          <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-parent="#accordion8">
            <div className="card-body">
              Yes, the University is entitled by the University Grants Commission (UGC) 
              to offer online degree programs. Additionally, our MBA and MCA programs
        ...
        <div className="card">
          <div className="card-header" id="headingEight">
            <h5 className="mb-0">
              <button className="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseEight" aria-expanded="false" aria-controls="collapseThree">
                How many credits does the program have?
              </button>
            </h5>
          </div>
