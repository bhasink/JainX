        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 col-lg-7 text-center align-self-center">
              ...
              <p>
                Our handpicked, high demand industry programs transform you to
                be global leaders
              </p>
        ...
        <div className="container">
          <div className="row">
            ...
            >
              ...
              <p>
                Ranked among the top universities in India &amp; considered a
                cerebral destination for students across the world &amp;
                Bangalore in particular, for its illustrious history of
                developing talent,Jain (Deemed-to-be University) is a hub for
                ...
                courses.map((coursesData, key) => (
                  <div className="item">
                    <div className="panelcards">
                      <img
                        src={`/images/courseslogo/` + coursesData.logo}
                        className="fllimg"
                      />
